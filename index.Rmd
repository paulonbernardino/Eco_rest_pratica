...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, R.options=list(width=100), 
                      fig.align='center', out.width='75%', fig.asp=1.0) 
```
...
```{r echo=TRUE, message=FALSE, out.height=700, out.width=1450}
